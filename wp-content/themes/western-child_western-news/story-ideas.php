...
<?php
  ...
  //response messages
  $not_human       = "Something is not right.";
  ...
  if ($_POST['submitted']) {
    ...
    $response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6LeTahQTAAAAAOs9DuHu6SY90kJqnV1Idz223VYX&response=".$captcha."&remoteip=".$_SERVER['REMOTE_ADDR']);
              ...
              <article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
                ...
                <section class="entry-content clearfix" itemprop="articleBody">
                  ...
                  <div id="respond" class="respond-form">
                    ...
                    <fieldset>
                      <div class="g-recaptcha" data-sitekey="6LeTahQTAAAAAG8ZtSM9rjZp9gITpFiK621jRymi"></div>
