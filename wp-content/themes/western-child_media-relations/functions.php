...
function bones_added_register_sidebars() {
    ...
    register_sidebar(array(
        'id' => 'sidebar6',
        'name' => __( 'Entrepreneurship Sidebar', 'bonestheme' ),
        'description' => __( 'Sidebar for Entrepreneurship.', 'bonestheme' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widgettitle">',
        'after_title' => '</h4>',
...
if ( ! function_exists('entrepreneurship_link') ) {

// Register Custom Post Type
function entrepreneurship_link() {

	$labels = array(
		'name'                  => _x( 'Entrepreneurship Links', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Entrepreneurship Link', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Entrepreneurship Links', 'text_domain' ),
		'name_admin_bar'        => __( 'Entrepreneurship Links', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Entrepreneurship Link', 'text_domain' ),
		'description'           => __( 'A list of links that point to entrepreneurship stories, connected to Western.', 'text_domain' ),
		'labels'                => $labels,
		...
		'show_in_nav_menus'     => true,
		'can_export'            => true,
		'has_archive'           => 'entrepreneurship',
		'exclude_from_search'   => false,
		'publicly_queryable'    => true,
		'rewrite'               => $rewrite,
		'capability_type'       => 'post',
	);
	register_post_type( 'entrepreneurship', $args );
	flush_rewrite_rules();
}
add_action( 'init', 'entrepreneurship_link', 0 );
